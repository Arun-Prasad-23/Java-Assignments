...
class Book {
    ...
    public String showDueDate() {
        return "Due date: 11 days from issue.";
    }
...
public class LibrarySystem {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Java Programming", "James Gosling", "1234", "Sun Publications");
        Book book2 = new Book("Python Basics", "Guido van Rossum", "7891", "Python Org");
        database.addBook(book1);
        database.addBook(book2);

        User user = new User("Arun", "Arun Prasad", "U001", "password123");
